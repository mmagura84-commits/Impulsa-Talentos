...
--   NOTE: numbered 036 (not 035) to keep monotonic apply order after migration
--   035_campaigns.sql (PR #155) took the 035 prefix. Fresh-env order:
--   035_campaigns -> 036_official_marketing_channels (filename sort).
-- ═══════════════════════════════════════════════════════════════════════════
