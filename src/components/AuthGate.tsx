...
// Social providers remain implemented in useAuth for later re-enablement.
// Keep disabled until provider credentials and redirect URLs are verified.
// TODO: Set to true after Google/Apple Supabase configuration is complete.
